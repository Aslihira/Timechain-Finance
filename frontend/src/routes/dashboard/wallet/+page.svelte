<script lang="ts">
  ...
  const handleAddFunds = async () => {
    ...
    try {
      ...
      const response = await addFundsToWallet({ amount, paymentMethod });
      successMessage = 'Funds added successfully!';
      errorMessage = '';
      console.log('Funds added:', response);
    } catch (error) {
      successMessage = '';
...
<div class="page-container">
  ...
  <div class="wallet-container">
    ...
    <button class="submit-button" on:click={handleAddFunds}>Add Funds</button>
    {#if successMessage}
